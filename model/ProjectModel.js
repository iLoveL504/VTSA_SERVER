...
class ProjectModel {
    ...
    console.log(typeof new Date(payload.handover_end_date))
    ...
    await pool.query(`
        update projects set project_end_date = :endDate where id = :id
    `, {endDate: new Date(payload.handover_end_date), id: id})
